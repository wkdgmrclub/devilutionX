...
struct EnhancedOptions : OptionCategoryBase {
	...
	/** @brief Search spell will not appear on Scrolls, Books, or Staves generated by monsters you kill or objects and vendors you interact with.  Automap shows Items.  Set Monk class skill to Infravision.  */
