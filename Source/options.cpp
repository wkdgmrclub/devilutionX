...
GameplayOptions::GameplayOptions()
    ...
    , runInTown("Run in Town", OptionEntryFlags::CantChangeInMultiPlayer | OptionEntryFlags::Invisible, N_("Run in Town"), N_("Enable jogging/fast walking in town for Diablo and Hellfire. This option was introduced in the expansion."), false)
    ...
    , multiplayerFullQuests("MultiplayerFullQuests", OptionEntryFlags::CantChangeInMultiPlayer | OptionEntryFlags::Invisible, N_("Full quests in Multiplayer"), N_("Enables the full/uncut singleplayer version of quests."), false)
    ...
    , experienceBar("Experience Bar", OptionEntryFlags::Invisible, N_("Experience Bar"), N_("Experience Bar is added to the UI at the bottom of the screen."), false)
