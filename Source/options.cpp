...
GameplayOptions::GameplayOptions()
    ...
    , disableSearch("Disable Search Spell", OptionEntryFlags::None, N_("Disable Search Spell"), N_("Search spell will not appear on Scrolls, Books, or Staves generated by monsters you kill or objects and vendors you interact with.  Set Monk class skill to Infravision."), false)
