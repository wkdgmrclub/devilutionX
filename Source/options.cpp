...
EnhancedOptions::EnhancedOptions()
	...
	, enableMonkDiablo("Enable Monk in Diablo", OptionEntryFlags::CantChangeInGame, N_("Enable Monk in Diablo"), N_("Allows selection of the Monk class when playing Diablo mode with hellfire.mpq loaded (hfmonk.mpq and hfvoice.mpq also required)."), false)
