...
GameplayOptions::GameplayOptions()
    ...
    , randomizeQuests("Randomize Quests", OptionEntryFlags::CantChangeInGame | OptionEntryFlags::Invisible, N_("Randomize Quests"), N_("Randomly selecting available quests for new games."), false)
