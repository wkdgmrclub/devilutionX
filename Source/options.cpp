...
GameplayOptions::GameplayOptions()
    ...
    , showItemLabels("Show Item Labels", OptionEntryFlags::None, N_("Show Item Labels"), N_("Show labels for items on the ground when enabled.  If playing Hellfire, consider the Disable Search Spell option."), false)
    , disableSearch("Disable Search Spell", OptionEntryFlags::None, N_("Disable Search Spell"), N_("Search spell will not appear on Scrolls, Books, or Staves for you.  Set Monk class skill to Infravision."), false)
